        ...
        <div class=" container m-5">
            <div class="">
                ...
                <div class="flex justify-start">
                    <!-- Search -->
                        <x-search route="doctor.search_appointements"></x-search>
                    <!-- Search -->
                </div>
                    ...
                    <tr class="bg-white  border-b dark:bg-white font-medium dark:border-gray-100">
                        ...
                        <td>
                            <div class="flex flex-col    p-2.5">
                                ...
                                <div class="w-11 h-11 flex-shrink-0 object-cover  object-center rounded-full shadow mr-3">
                                    <img src="{{asset('storage/patients/'.$appointment->patients->photo)}}" alt="photo" class="w-full h-full rounded-full mx-auto"><br>
                                </div>
                                @else
                                <div class="w-11 h-11 flex-shrink-0 object-cover object-center rounded-full shadow mr-3">
                                    <img src="{{asset('storage/img/profile.svg')}}" alt="photo" class="w-full h-full rounded-full mx-auto "><br>
                                </div>
                        ...
                        <td>
                            <div class="flex justify-center mt-5">
                                ...
                                <a href="{{route('doctor.appointement_details',$appointment->id)}} "  data-tooltip-target="tooltip-view"  class="text-white  text-sm px-5 py-2 text-center mb-2" type="button">
        ...
        <div class="relative w-full h-full m-6 ">
            ...
            <div class="relative bg-white  rounded-lg shadow ">
                ...
                <div class="grid grid-cols-1 md\:grid-cols-2 pt-4 px-2">
                    <form method="post"  enctype="multipart/form-data" action="{{route("doctor.store_appointements")}}">
                        @csrf
                        @method("POST")
                              ...
                              <div class="w-full mb-6 group">
                                ...
                                <!-- fees -->
                                 <div class="w-full mb-6 group">
                                    ...
                                    <input type="number" name="extra_fees" value="0" id="fees" class="block p-2.5  w-full text-sm text-gray-900 bg-transparent border  border-gray-300 rounded-md appearance-none  dark:focus:border-cyan-500 focus:outline-none focus:ring-0 focus:border-cyan-600 peer" placeholder="0$">
                                    </div>
                                </div>        
        ...
        <div class="relative w-full h-full max-w-2xl md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow ">
                ...
                <div class="flex items-start justify-between p-4 border-b rounded-t  dark:border-gray-100">
                    ...
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="deleteAppointement">
                        <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                        <span class="sr-only">Close modal</span>
                    </button>
                </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <form  action="{{route("doctor.delete_appointements",$appointment->id)}}" method="POST"
