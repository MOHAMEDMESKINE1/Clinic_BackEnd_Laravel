                    ...
                    <form method="post"  enctype="multipart/form-data" action="#">
                        <div class="grid grid-col-1 md:grid-cols-2 gap-2">
                            ...
                            <div class="w-full group">
                                ...
                                <textarea name="description" id="editor" cols="10" rows="10" class="block mt-1 p-2.5 mr-2  w-full text-sm text-gray-900 bg-transparent border  border-gray-300 rounded-md appearance-none  dark:focus:border-cyan-500 focus:outline-none focus:ring-0 focus:border-cyan-600 peer"></textarea>
                            </div>
                    </div>        
                    </form>
