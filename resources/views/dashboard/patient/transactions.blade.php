...
<body class="bg-gray-100">
    ...
    <div class="grid grid-col-1 md:grid-col-2">
        ...
        <div class="flex flex-col sm:flex-row justify-between ">
            ...
            <!-- Search -->
                <x-search route="patient.search_transactions"></x-search>
            <!-- Search -->
                    ...
                    <tr class="bg-white  border-b dark:bg-white font-medium dark:border-gray-100">
                        <td>
                            <div class="flex items-center mx-2">
                                ...
                                <div class="flex flex-col p-2.5">
                                    ...
                                    href="{{route("patient.transactions_details",$transaction->patients->id)}}" 
                                    >
                        ...
                        <td>
                            <div class="flex justify-center mt-5">
                                ...
                                <a href="{{route('patient.transactions_details',$transaction->patients->id)}}"  data-tooltip-target="tooltip-view"  data-modal-target="editDoctor" data-modal-toggle="editDoctor" class="text-white mx-2  w-25 font-medium rounded-lg text-sm px-5 py-2 text-center mb-2" type="button">
