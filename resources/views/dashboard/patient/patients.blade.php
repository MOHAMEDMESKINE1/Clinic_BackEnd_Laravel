    ...
    <div class="grid grid-col-1 md:grid-col-2">
        ...
        <div class=" container m-5 ">
            <div class="">
               ...
               <div class="mx-8">
                <button  data-modal-target="addPatient" data-modal-toggle="addPatient" class="text-white bg-gradient-to-br w-40  from-cyan-600 to-cyan-500 hover:bg-gradient-to-bl focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2" type="button">
                    Add Patient
                </button>
               </div>
                </div>
    ...
    <div class="grid grid-cols-1 ">
        <div class=" col-span-2 bg-white mx-4 p-4 shadow text-center rounded-md dark:bg-darker relative overflow-x-auto">
            ...
            <table class="w-full text-sm  text-center   overflow-hidden rounded-md ">
                ...
                <tbody>
                    <tr class="bg-white border-b dark:bg-white font-medium dark:border-gray-100">
                        ...
                        <td>
                            <span class="bg-red-500  text-sm font-semibold  px-1 py-1  rounded-full mr-2 text-white">
                                <b >0</b>
                              </span>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="flex justify-center mt-2">
                                ...
                                <a href="#"  data-tooltip-target="tooltip-email"  data-modal-target="emailPatient" data-modal-toggle="emailPatient" class="text-white bg-gradient-to-br w-25 mx-2  from-cyan-600 to-cyan-500 hover:bg-gradient-to-bl focus:outline-none font-medium rounded-lg text-sm px-4 py-1 text-center mb-2" type="button">
                                    <i class="fas fa-solid fa-envelope"></i>
                                </a>                                
                                <a href="#"  data-tooltip-target="tooltip-edit"  data-modal-target="editPatient" data-modal-toggle="editPatient" class="text-white bg-gradient-to-br w-25  from-blue-600 to-blue-500 hover:bg-gradient-to-bl focus:outline-none font-medium rounded-lg text-sm px-4 py-1 text-center mb-2" type="button">
                                    <i class="fas fa-edit"></i>
                                </a>                                
                                <a href="#"  data-tooltip-target="tooltip-delete"   data-modal-target="deletePatient" data-modal-toggle="deletePatient" class="text-white mx-2 bg-gradient-to-br w-25  from-red-600 to-red-500 hover:bg-gradient-to-bl focus:outline-none font-medium rounded-lg text-sm px-4 py-1 text-center mb-2" type="button">
           ...
           <div class="flex items-between">
             ...
             <!-- show result -->
            <!-- navigation -->
            <nav class="flex items-start justify-between items-end mt-2 pt-4" aria-label="Table navigation">
