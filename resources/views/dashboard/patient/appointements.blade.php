    ...
    <head>
        ...
        <title>Patient Appointements</title>
                            ...
                            <tr class="bg-white  border-b dark:bg-white font-medium dark:border-gray-100">
                                ...
                                <td>
                                    <div class="flex justify-center mt-5">
                                        <!-- view -->
                                        <a href=""  data-tooltip-target="tooltip-cancel"   class="text-white  w-25 text-sm  mx-2 text-center mb-2" type="button">
                                        ...
                                        <!-- delete -->
                                        <a href=""  data-tooltip-target="tooltip-delete"   class="text-white  w-25 text-sm  mx-2 text-center mb-2" type="button">
