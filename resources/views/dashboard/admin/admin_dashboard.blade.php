...
<!-- changePassword -->
    <div id="changePassword" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden  overflow-y md:inset-0 h-[calc(100%-1rem)] md:h-full">
