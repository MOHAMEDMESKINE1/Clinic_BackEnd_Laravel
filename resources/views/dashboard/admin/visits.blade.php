    ...
    <div class="grid grid-col-1 md:grid-col-2">
        ...
        <div class=" container ">
            <div class="m-5">
                ...
                <x-search route="admin.search_visits"></x-search>
                    ...
                    <tr class="bg-white  border-b dark:bg-white font-medium dark:border-gray-100">
                            ...
                            <div class="flex justify-center">
                                @if ($visit->doctors->photo)
                                    ...
                                    <div class="flex flex-col">
                                        <a class="text-green-700" href="{{route('admin.visits_details',$visit->doctors->id)}}">
                            ...
                            <div class="flex  justify-center p-2.5">
                                ...
                                @endif
                                    ...
                                    <div class="flex flex-col p-2.5">
                                        <a class="text-green-700" href="{{route('admin.visits_details',$visit->patients->id)}}">
                        ...
                        <td>
                            <div class="flex justify-center mt-5">
                                <!-- view -->
                                <a href="{{route('admin.visits_details',$visit->id)}}"  data-tooltip-target="tooltip-view"  class="text-white   px-5 py-2 text-center mb-2" type="button">
                                    <i class="fas fa-eye text-xl text-green-700"></i>
                                </a> 
                                <!-- edit -->
                                <a href="{{route('admin.edit_visits',$visit->id)}}"  data-tooltip-target="tooltip-edit"   data-modal-target="editVisit" data-modal-toggle="editVisit" class="text-white  px-5 py-2 text-center mb-2" type="button">
        ...
        <div class="relative w-full h-full m-6 ">
            ...
            <div class="relative bg-white  rounded-lg shadow ">
                ...
                <div class="grid grid-cols-1 md\:grid-cols-2 pt-4 px-2">
                    <form method="post"  enctype="multipart/form-data" action="{{route("admin.store_visits")}}">
                        @csrf
                        @method("POST")
        ...
        <div class="relative w-full h-full max-w-2xl md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow ">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <form method="POST"  action="{{route("admin.delete_visits",$visit->id)}}">
                        @csrf
                        @method("DELETE")
                        <!-- modal footer -->
