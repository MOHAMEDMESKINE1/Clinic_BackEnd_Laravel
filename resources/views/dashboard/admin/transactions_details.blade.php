...
<body class="bg-gray-100">
   <div class="m-5 ml-10 flex justify-between ">
    ...
    <a href="{{route('admin.transactions')}}" class="relative inline-flex items-center justify-center p-0.5 mb-2 mr-5 w-75 overflow-hidden text-sm font-medium dark:text-gray-900 rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500">
